...
class Profile
 ...
 # the value of the @age variable using = format instead of the standard
 # argument format. Look at line 71 to see what I mean. The equals sign
...
#Let's see the final product now. We changed all of the values using setters,
#so everything is different than before.
